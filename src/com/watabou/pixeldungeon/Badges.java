...
public class Badges {
	...
	public static enum Badge {
		...
		ALL_ITEMS_IDENTIFIED(RLoader.get("badge.all.identified"), 35, true ),
		BAG_BOUGHT_SEED_POUCH,
		BAG_BOUGHT_SCROLL_HOLDER,
		BAG_BOUGHT_WAND_HOLSTER,
		ALL_BAGS_BOUGHT(RLoader.get("badge.allbags.bought"), 23 ),
		DEATH_FROM_FIRE(RLoader.get("badge.deathby.fire"), 24 ),
		DEATH_FROM_POISON(RLoader.get("badge.deathby.poison"), 25 ),
		DEATH_FROM_GAS(RLoader.get("badge.deathby.toxicgas"), 26 ),
		DEATH_FROM_HUNGER(RLoader.get("badge.deathby.hunger"), 27 ),
		DEATH_FROM_GLYPH(RLoader.get("badge.deathby.ench"), 57 ),
		DEATH_FROM_FALLING(RLoader.get("badge.deathby.falling"), 59 ),
		YASD(RLoader.get("badge.deathby.all"), 34, true ),
		BOSS_SLAIN_1_WARRIOR,
		BOSS_SLAIN_1_MAGE,
		BOSS_SLAIN_1_ROGUE,
		BOSS_SLAIN_1_HUNTRESS,
		BOSS_SLAIN_1(RLoader.get("badge.slainboss.1"), 12 ),
		BOSS_SLAIN_2(RLoader.get("badge.slainboss.2"), 13 ),
		BOSS_SLAIN_3(RLoader.get("badge.slainboss.3"), 14 ),
		BOSS_SLAIN_4(RLoader.get("badge.slainboss.4"), 15 ),
		BOSS_SLAIN_1_ALL_CLASSES(RLoader.get("badge.slainboss_allchar.1"), 32, true ),
		...
		BOSS_SLAIN_3_SNIPER,
		BOSS_SLAIN_3_WARDEN,
		BOSS_SLAIN_3_ALL_SUBCLASSES(RLoader.get("badge.slainboss_allsubclasses.3"), 33, true ),
		RING_OF_HAGGLER(RLoader.get("badge.findItem_ring.haggler"), 20 ),
		RING_OF_THORNS(RLoader.get("badge.findItem_ring.thorns"), 21 ),
		STRENGTH_ATTAINED_1(RLoader.get("badge.str.13"), 40 ),
		STRENGTH_ATTAINED_2(RLoader.get("badge.str.15"), 41 ),
		STRENGTH_ATTAINED_3(RLoader.get("badge.str.17"), 42 ),
		STRENGTH_ATTAINED_4(RLoader.get("badge.str.19"), 43 ),
		FOOD_EATEN_1(RLoader.get("badge.foodEaten.10"), 44 ),
		FOOD_EATEN_2(RLoader.get("badge.foodEaten.20"), 45 ),
		FOOD_EATEN_3(RLoader.get("badge.foodEaten.30"), 46 ),
		FOOD_EATEN_4(RLoader.get("badge.foodEaten.40"), 47 ),
		MASTERY_WARRIOR,
		MASTERY_MAGE,
		MASTERY_ROGUE,
		MASTERY_HUNTRESS,
		ITEM_LEVEL_1(RLoader.get("badge.itemLvl.3"), 48 ),
		ITEM_LEVEL_2(RLoader.get("badge.itemLvl.6"), 49 ),
		ITEM_LEVEL_3(RLoader.get("badge.itemLvl.9"), 50 ),
		ITEM_LEVEL_4(RLoader.get("badge.itemLvl.12"), 51 ),
		RARE_ALBINO,
		RARE_BANDIT,
		RARE_SHIELDED,
		RARE_SENIOR,
		RARE_ACIDIC,
		RARE(RLoader.get("badge.slainRareMonster.all"), 37, true ),
		VICTORY_WARRIOR,
		VICTORY_MAGE,
		VICTORY_ROGUE,
		VICTORY_HUNTRESS,
		VICTORY(RLoader.get("badge.findItem.AmuletYendor"), 22 ),
		VICTORY_ALL_CLASSES(RLoader.get("badge.findItem_allclasses.AmuletYendor"), 36, true ),
		MASTERY_COMBO(RLoader.get("badge.combo.7"), 56 ),
		POTIONS_COOKED_1(RLoader.get("badge.potions_cooking.3"), 52 ),
		POTIONS_COOKED_2(RLoader.get("badge.potions_cooking.6"), 53 ),
		POTIONS_COOKED_3(RLoader.get("badge.potions_cooking.9"), 54 ),
		POTIONS_COOKED_4(RLoader.get("badge.potions_cooking.12"), 55 ),
		POTIONS_COOKED_5(RLoader.get("badge.potions_cooking.15"), 55 ),
		NO_MONSTERS_SLAIN(RLoader.get("badge.no-monster-slain"), 28 ),
		GRIM_WEAPON(RLoader.get("badge.killEnemy.withGrim"), 29 ),
		PIRANHAS_1(RLoader.get("badge.killPiranhas.6"), 30 ),
		PIRANHAS_2(RLoader.get("badge.killPiranhas.12"), 30 ),
		PIRANHAS_3(RLoader.get("badge.killPiranhas.18"), 30 ),
		NIGHT_HUNTER(RLoader.get("badge.nighthunter"), 58 ),
		GAMES_PLAYED_1(RLoader.get("badge.playgames.10"), 60, true ),
		GAMES_PLAYED_2(RLoader.get("badge.playgames.100"), 61, true ),
		GAMES_PLAYED_3(RLoader.get("badge.playgames.500"), 62, true ),
		GAMES_PLAYED_4(RLoader.get("badge.playgames.2000"), 63, true ),
		HAPPY_END(RLoader.get("badge.happyend"), 38 ),
		CHAMPION(RLoader.get("badge.challenge_won"), 39, true ),
		SUPPORTER(RLoader.get("badge.thanks-for-supp"), 31, true );
