...
public class ToxicGas extends Blob implements Hero.Doom {
	...
	public String tileDesc() {
		return BlobData.BLOB_GAS_TOXIC_DESC;
	}
	...
	public void onDeath() {
		...
		Dungeon.fail( Utils.format( HeroData.ResultDescriptions.RESULT_GAS, Dungeon.depth ) );
		GLog.n(HeroData.Death.DEATH_TOXIC_GAS);
	}
}
