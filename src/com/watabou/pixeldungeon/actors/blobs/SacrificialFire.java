...
public class SacrificialFire extends Blob {
		...
		if (fire != null) {
			...
			if (exp > 0) {
				...
				if (volume > 0) {
					...
					GLog.w(BlobData.BLOB_SACRIFICIAL_FIRE_WORTHY);
				} else {
					fire.seed( fire.pos, 0 );
					Journal.remove( Feature.SACRIFICIAL_FIRE );
					
					GLog.w(BlobData.BLOB_SACRIFICIAL_FIRE_REWARD);
				...
				GLog.w(BlobData.BLOB_SACRIFICIAL_FIRE_UNWORTHY);
	...
	public String tileDesc() {
		return BlobData.BLOB_SACRIFICIAL_FIRE_DESC;
	}
	...
	public static class Marked extends FlavourBuff {
		...
		public String toString() {
			return BlobData.BLOB_SACRIFICIAL_FIRE_MARKED;
		}
