...
public class Yog extends Mob {
	...
	{
		name = Dungeon.depth == Statistics.deepestFloor ? MobData.Bosses.MOB_YOG_NAME : MobData.Bosses.MOB_YOG_ECHO_NAME;
	...
	public void die( Object cause ) {
		...
		yell(MobData.Bosses.MOB_YOG_KILL);
	}
	
	@Override
	public void notice() {
		super.notice();
		yell(MobData.Bosses.MOB_YOG_NOTICE);
	}
	
	@Override
	public String description() {
		return MobData.Bosses.MOB_YOG_DESC;
	...
	public static class RottingFist extends Mob {
		...
		{
			name = MobData.Bosses.MOB_FIST_ROTTING_NAME;
	...
	public static class BurningFist extends Mob {
		...
		{
			name = MobData.Bosses.MOB_FIST_BURNING_NAME;
			...
			if (!Level.adjacent( pos, enemy.pos )) {
				...
				if (hit( this, enemy, true )) {
					...
					if (!enemy.isAlive() && enemy == Dungeon.hero) {
						Dungeon.fail( Utils.format( HeroData.ResultDescriptions.RESULT_BOSS, name, Dungeon.depth ) );
