...
public abstract class Mob extends Char {
	...
	public void add( Buff buff ) {
		...
		if (buff instanceof Amok) {
			if (sprite != null) {
				sprite.showStatus( CharSprite.NEGATIVE, MobData.Common.MOB_TXT_RAGE);
			}
			state = HUNTING;
	...
	public void destroy() {
		...
		if (Dungeon.hero.isAlive()) {
			...
			int exp = exp();
			if (exp > 0) {
				Dungeon.hero.sprite.showStatus( CharSprite.POSITIVE, MobData.Common.MOB_TXT_EXP, exp );
	...
	public void die( Object cause ) {
		...
		if (Dungeon.hero.isAlive() && !Dungeon.visible[pos]) {	
			GLog.i(MobData.Common.MOB_TXT_DIED);
		}
	}
	...
	private class Sleeping implements AiState {
		...
		@Override
		public String status() {
			return Utils.format(MobData.Common.MOB_TXT_SLEEPING, name );
		}
	}
	...
	private class Wandering implements AiState {
		...
		@Override
		public String status() {
			return Utils.format(MobData.Common.MOB_TXT_WANDERING, name );
		}
	}
	...
	private class Hunting implements AiState {
		...
		@Override
		public String status() {
			return Utils.format(MobData.Common.MOB_TXT_HUNTING, name );
		}
	}
	...
	protected class Fleeing implements AiState {
		...
		@Override
		public String status() {
			return Utils.format(MobData.Common.MOB_TXT_FLEEING, name );
		}
	}
	...
	private class Passive implements AiState {
		...
		@Override
		public String status() {
			return Utils.format(MobData.Common.MOB_TXT_PASSIVE, name );
		}
	}
}
