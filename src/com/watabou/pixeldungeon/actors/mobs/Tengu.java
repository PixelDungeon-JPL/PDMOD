...
public class Tengu extends Mob {
	...
	{
		name = Dungeon.depth == Statistics.deepestFloor ? MobData.Bosses.MOB_TENGU_NAME : MobData.Bosses.MOB_TENGU_MEMORY_NAME;
	...
	public void die( Object cause ) {
		...
		yell(MobData.Bosses.MOB_TENU_KILL);
	}
	...
	public void notice() {
		super.notice();
		yell(MobData.Bosses.MOB_TENGU_NOTICE);
	}
	
	@Override
	public String description() {
		return MobData.Bosses.MOB_TENGU_DESC;
	}
