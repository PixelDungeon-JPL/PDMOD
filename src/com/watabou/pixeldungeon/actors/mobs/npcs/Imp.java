...
public class Imp extends NPC {
	...
	{
		name = MobData.NPC.Imp.NPC_IMP_NAME;
	...
	protected boolean act() {
		...
		if (!Quest.given && Dungeon.visible[pos]) {
			if (!seenBefore) {
				yell( Utils.format(MobData.NPC.Imp.NPC_IMP_TXT_HEY, Dungeon.hero.className() ) );
			}
			seenBefore = true;
		} else {
			seenBefore = false;
	...
	public String defenseVerb() {
		return MobData.NPC.Imp.NPC_IMP_DEFENSE;
	}
	...
	public void interact() {
		...
		if (Quest.given) {
			...
			if (tokens != null && (tokens.quantity() >= 8 || (!Quest.alternative && tokens.quantity() >= 6))) {
				...
				tell( Quest.alternative ? MobData.NPC.Imp.NPC_IMP_TXT_MONKS_2 : MobData.NPC.Imp.NPC_IMP_TXT_GOLEMS_2, Dungeon.hero.className() );
			}
			
		} else {
			tell( Quest.alternative ? MobData.NPC.Imp.NPC_IMP_TXT_MONKS_1 : MobData.NPC.Imp.NPC_IMP_TXT_GOLEMS_1);
			Quest.given = true;
	...
	public void flee() {
		...
		yell( Utils.format(MobData.NPC.Imp.NPC_IMP_TXT_CYA, Dungeon.hero.className() ) );
	...
	public String description() {
		return MobData.NPC.Imp.NPC_IMP_DESC;
	}
