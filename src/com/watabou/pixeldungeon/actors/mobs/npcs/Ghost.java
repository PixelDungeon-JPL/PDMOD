...
public class Ghost extends NPC {
	...
	{
		name = MobData.NPC.Ghost.NPC_GHOST_NAME;
	...
	public String defenseVerb() {
		return MobData.NPC.Ghost.NPC_GHOST_DEFENSE;
	}
	...
	public String description() {
		return MobData.NPC.Ghost.NPC_GHOST_DESC;
	}
	...
	private static final QuestHandler roseQuest = new QuestHandler() {
		...
		public void interact( Ghost ghost ) {
			if (Quest.given) {
				...
				if (item != null) {
					GameScene.show( new WndSadGhost( ghost, item, MobData.NPC.Ghost.NPC_GHOST_TXT_ROSE_3) );
				} else {
					GameScene.show( new WndQuest( ghost, MobData.NPC.Ghost.NPC_GHOST_TXT_ROSE_2) );
					relocate( ghost );
				}
				
			} else {
				GameScene.show( new WndQuest( ghost, MobData.NPC.Ghost.NPC_GHOST_TXT_ROSE_1) );
				Quest.given = true;
	...
	private static final QuestHandler ratQuest = new QuestHandler() {
		...
		public void interact( Ghost ghost ) {
			if (Quest.given) {
				...
				if (item != null) {
					GameScene.show( new WndSadGhost( ghost, item, MobData.NPC.Ghost.NPC_GHOST_TXT_RAT_3) );
				} else {
					GameScene.show( new WndQuest( ghost, MobData.NPC.Ghost.NPC_GHOST_TXT_RAT_2) );
					relocate( ghost );
				}
				
			} else {
				GameScene.show( new WndQuest( ghost, MobData.NPC.Ghost.NPC_GHOST_TXT_RAT_1) );
				Quest.given = true;
	...
	private static final QuestHandler curseQuest = new QuestHandler() {
		...
		public void interact( final Ghost ghost ) {
			if (Quest.given) {
				...
				GameScene.show( new WndSadGhost( ghost, null, Utils.format(MobData.NPC.Ghost.NPC_GHOST_TXT_CURSE_2, Dungeon.hero.className() ) ) );
				
			} else {
				GameScene.show( new WndQuest( ghost, MobData.NPC.Ghost.NPC_GHOST_TXT_CURSE_1, MobData.NPC.Ghost.NPC_GHOST_TXT_YES, MobData.NPC.Ghost.NPC_GHOST_TXT_NO) {
