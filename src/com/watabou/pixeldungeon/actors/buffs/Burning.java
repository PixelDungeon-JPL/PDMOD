...
public class Burning extends Buff implements Hero.Doom {
		...
		if (target.isAlive()) {
			...
			if (target instanceof Hero) {
				...
				if (item instanceof Scroll) {
					...
					GLog.w(BuffData.BUFF_BURNING_TXT_BURNS_UP, item.toString() );
	...
	public String toString() {
		return BuffData.BUFF_BURNING_DESC;
	}
	...
	public void onDeath() {
		...
		Dungeon.fail( Utils.format( HeroData.ResultDescriptions.RESULT_BURNING, Dungeon.depth ) );
		GLog.n(HeroData.Death.DEATH_FIRE);
	}
}
