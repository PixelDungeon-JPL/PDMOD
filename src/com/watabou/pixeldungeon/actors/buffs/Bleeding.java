...
public class Bleeding extends Buff {
	...
	public String toString() {
		return BuffData.BUFF_BLEEDING_DESC;
	}
		...
		if (target.isAlive()) {
			...
			if ((level = Random.Int( level / 2, level )) > 0) {
				...
				if (target == Dungeon.hero && !target.isAlive()) {
					Dungeon.fail( Utils.format( HeroData.ResultDescriptions.RESULT_BLEEDING, Dungeon.depth ) );
					GLog.n(HeroData.Death.DEATH_BLEEDING);
				}
